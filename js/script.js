...
function printQuote () {
  ...
  htmlString += '<p class="quote">' + (callGetRandomQuote.text ? callGetRandomQuote.text : "Click for next") + '</p>';
  htmlString += '<p class="source">' + (callGetRandomQuote.author ? callGetRandomQuote.author : ".");
